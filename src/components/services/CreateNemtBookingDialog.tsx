...
export default function CreateNemtBookingDialog({
  children,
}: PropsWithChildren) {
  ...
  function onSubmit(data: NemtFormValues) {
    // For now just log the data; backend integration can be added later
    // eslint-disable-next-line no-console
    console.log("Create NEMT Booking:", data);
    setOpen(false);
  }
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-xl max-h-[80vh] overflow-y-auto p-0">
        <DialogHeader className="p-4 pb-0">
          <DialogTitle>Create New NEMT Booking</DialogTitle>
          <DialogDescription className="sr-only">
            Fill in the patient and trip details to create a booking
          </DialogDescription>
        </DialogHeader>
